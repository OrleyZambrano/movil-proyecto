...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#f1f5f9', fontSize: 24, fontWeight: '800', marginBottom: 10 },
  catBtn: { flexDirection: 'row', backgroundColor: '#1e293b', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 20, alignItems: 'center', flex: 1, justifyContent: 'center' },
